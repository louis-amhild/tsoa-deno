module.exports = {
  ...
  parserOptions: {
    project: ['./packages/**/tsconfig.json', './tests/tsconfig.json', './tests/esm/tsconfig.json', './tests/fixtures/hono/deno.json', './deno-example/tsconfig.json'],
    sourceType: 'module',
  },
  ...
  overrides: [
    ...
    },
    {
      ...
      "parser": "@typescript-eslint/parser",
      "parserOptions": {
        "project": "tests/fixtures/hono/deno.json"
      },
    },
  ],
};
