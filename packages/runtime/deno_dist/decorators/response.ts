import { IsValidHeader } from '../utils/isHeaderType.ts';
import { HttpStatusCodeLiteral, HttpStatusCodeStringLiteral, OtherValidOpenApiHttpStatusCode } from '../interfaces/response.ts';
