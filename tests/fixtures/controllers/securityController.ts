import { Get, Request, Response, Route, Security } from '@tsoa-deno/runtime';
...
export class SecurityTestController {
  ...
  @Security('api_key')
  @Get('Hono')
  public async GetWithApiForHono(@Request() request: RequestWithUser): Promise<UserResponseModel> {
    return Promise.resolve(request.user);
  }
