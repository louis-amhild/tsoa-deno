...
import { basename, dirname, resolve, extname } from 'https://deno.land/std@0.214.0/path/mod.ts';
...
import { Gender, GenericModel, GenericRequest, Model, ParameterTestModel, TestClassModel, TestModel, ValidateMapStringToAny, ValidateMapStringToNumber, ValidateModel } from '../testModel.ts';

type SuperTest<T> = SuperDeno;

Deno.test('can test in Deno', () => {
  const x = 1 + 2;
  assertEquals(x, 3);
});
...
Deno.test('can handle get request to root controller`s path', () => {
...
Deno.test('can handle get request to root controller`s method path', () => {
...
Deno.test('can handle get request with no path argument', () => {
...
Deno.test('can handle get request with path argument', () => {
...
Deno.test('respects toJSON for class serialization', () => {
...
Deno.test('can handle get request with collection return value', () => {
...
Deno.test('can handle get request with path and query parameters', () => {
...
Deno.test('returns error if missing required query parameter', () => {
  return verifyGetRequest(
    basePath + `/GetTest/${1}/true/test?booleanParam=true&stringParam=test1234`,
    (err: any, _res: any) => {
      expect(err.fields.numberParam.message).to.equal(`'numberParam' is required`);
    },
    400,
  );
});

Deno.test('returns error and custom error message', () => {
  return verifyGetRequest(
    basePath + `/GetTest/${1}/true/test?booleanParam=true&numberParam=1234`,
    (err: any, _res: any) => {
      expect(err.fields.stringParam.message).to.equal(`Custom error message`);
    },
    400,
  );
});

Deno.test('parsed body parameters', () => {
...
Deno.test('correctly returns status code', () => {
  const data = getFakeModel();
...
Deno.test('parses class model as body parameter', () => {
  const model = getFakeClassModel();
  // TODO: Test sends protected and private TestClassModel properties (ie. protectedConstructorVar) which are excess...?
  // Remove protectedConstructorVar (as it is not part of the )
  const { protectedConstructorVar, ...data } = model as any;
...
Deno.test('correctly handles OPTIONS requests', () => {
...
Deno.test('should reject invalid strings', async () => {
...
Deno.test('should parse valid date', () => {
  const data = getFakeModel();
...
Deno.test('should parse valid date as query param', () => {
  return verifyGetRequest(
...
Deno.test('should reject invalid dates', async () => {
...
Deno.test('should reject invalid numbers', async () => {
...
Deno.test('returns error if missing required path parameter', () => {
  return verifyGetRequest(
    basePath + `/GetTest/${1}/true?booleanParam=true&stringParam=test1234`,
    (err: any, _res: any) => {
      // Obs. text in Hono is "404 Not Found" and statusText is "Not Found" unlike Express
      expect(err.text).to.equal('404 Not Found');
    },
    404,
  );
});

Deno.test('should reject invalid additionalProperties', async () => {
...
Deno.test('returns error if invalid request', () => {
  const data = getFakeModel();
  ...
  return verifyPostRequest(
    ...
    (err: any, _res: any) => {
      ...
      expect(err.fields['model.dateValue'].message).to.equal('invalid ISO 8601 datetime format, i.e. YYYY-MM-DDTHH:mm:ss');
      expect(err.fields['model.dateValue'].value).to.equal(1);
    },
    400,
  );
});

Deno.test('returns error if thrown in controller', () => {
  return verifyGetRequest(
...
Deno.test('should normal status code', () => {
  return verifyGetRequest(
...
Deno.test('should normal status code with false boolean result', () => {
  return verifyGetRequest(
...
Deno.test('should normal status code with 0 result', () => {
  return verifyGetRequest(
...
Deno.test('should no content status code', () => {
  return verifyGetRequest(
...
Deno.test('should custom status code', () => {
  return verifyGetRequest(
...
Deno.test('should custom header', () => {
  return verifyGetRequest(
    ...
    (_err, res) => {
      ...
      // TODO: Is there an issue in superagent deno version or Deno fetch - this is a string, not an array
...
Deno.test('should unavailable for legal reasons status code', () => {
  return verifyGetRequest(
...
Deno.test('should return custom content-type if given', () => {
  return verifyPostRequest(
...
Deno.test('should apply custom code from success response', () => {
  return verifyGetRequest(
...
Deno.test('should apply enum code from success response', () => {
  return verifyGetRequest(
...
Deno.test('should ignore 2XX code range from success response', () => {
  return verifyGetRequest(
...
Deno.test('should valid minDate and maxDate validation of date type', () => {
...
Deno.test('should invalid minDate and maxDate validation of date type', () => {
...
Deno.test('should valid minDate and maxDate validation of datetime type', () => {
...
Deno.test('should invalid minDate and maxDate validation of datetime type', () => {
...
Deno.test('should valid max and min validation of integer type', () => {
  return verifyGetRequest(
...
Deno.test('should invalid max and min validation of integer type', () => {
  const value = 4;
  return verifyGetRequest(
...
Deno.test('should valid max and min validation of float type', () => {
  return verifyGetRequest(
...
Deno.test('should invalid max and min validation of float type', () => {
  const value = 4.5;
  return verifyGetRequest(
...
Deno.test('should valid validation of boolean type', () => {
  return verifyGetRequest(
...
Deno.test('should invalid validation of boolean type', () => {
...
Deno.test('should valid minLength, maxLength and pattern (quoted/unquoted) validation of string type', () => {
  return verifyGetRequest(
...
Deno.test('should invalid minLength, maxLength and pattern (quoted/unquoted) validation of string type', () => {
  const value = '1234';
  return verifyGetRequest(
...
Deno.test('should valid model validate', () => {
...
Deno.test('should invalid model validate', () => {
  const bodyModel = new ValidateModel();
...
Deno.test('should custom required error message', () => {
  return verifyGetRequest(
...
Deno.test('should custom invalid datatype error message', () => {
  const value = '112ab';
  return verifyGetRequest(
...
Deno.test('should validate string-to-number dictionary body', () => {
...
Deno.test('should reject string-to-string dictionary body', () => {
  const data: object = {
    key1: 'val0',
    key2: 'val1',
    key3: '-val1',
...
Deno.test('should validate string-to-any dictionary body', () => {
...
Deno.test('should validate string-to-any dictionary body with falsy values', () => {
  const data: ValidateMapStringToAny = {
    array: [],
    false: false,
    null: null,
...
Deno.test('can handle get request with access_token user id == 1', () => {
  return verifyGetRequest(basePath + '/SecurityTest/Hono?access_token=abc123456', (_err, res) => {
    const model = res.body as Model;
    expect(model.id).to.equal(1);
  });
});

Deno.test('can handle get request with access_token user id == 2', () => {
...
Deno.test({
  name: 'resolves right away after first success',
  sanitizeOps: false, // Disable the ops sanitizer as the slow_auth setTimeout is never cleared in this test
...
Deno.test('returns 200 if the API key is correct', () => {
...
const emptyHandler = (_err: any, _res: any) => {
  // This is an empty handler
};

Deno.test('returns 200 if tsoa auth is correct', () => {
...
Deno.test('returns 200 if multiple auth handlers are correct', () => {
  const path = '/SecurityTest/OauthOrApiKey?access_token=abc123456&tsoa=abc123456';
  return verifyGetRequest(basePath + path, emptyHandler, 200);
});

Deno.test('returns 401 if neither API key nor tsoa auth are correct, last error to resolve is returned', () => {
...
Deno.test('should pass through error if controller method crashes', () => {
  return verifyGetRequest(
...
Deno.test('returns 200 if API and tsoa auth pass validation, resolved with user from first key in object', () => {
...
Deno.test('returns 401 if API key is incorrect', () => {
...
Deno.test('returns 401 if tsoa auth is incorrect', () => {
...
Deno.test('parses query parameters', () => {
...
Deno.test('parses queries parameters', () => {
...
Deno.test('accepts any parameter using a wildcard', () => {
  const object = {
    foo: 'foo',
    bar: 10,
    baz: true,
...
Deno.test('should reject incompatible entries for typed wildcard', () => {
  const object = {
    foo: '2',
    bar: 10,
    baz: true,
...
Deno.test('accepts numbered parameters using a wildcard', () => {
  const object = {
    foo: '3',
    bar: 10,
  };
...
Deno.test('parses path parameters', () => {
...
Deno.test('parses header parameters', () => {
  return verifyRequest(
    (_err, res) => {
      const model = res.body as ParameterTestModel;
      expect(model.firstname).to.equal('Tony');
...
Deno.test('parses request parameters', () => {
...
Deno.test('parse request filed parameters', () => {
...
Deno.test('parses body parameters', () => {
  const data: ParameterTestModel = {
    age: 45,
    firstname: 'Tony',
    gender: Gender.MALE,
...
Deno.test('parses body props parameters', () => {
  const data: ParameterTestModel = {
    age: 45,
    firstname: 'Tony',
    gender: Gender.MALE,
...
Deno.test('can get request with generic type', () => {
...
Deno.test('can get request with generic array', () => {
...
Deno.test('can get request with generic primative type', () => {
...
Deno.test('can get request with generic primative array', () => {
...
Deno.test('can post request with a generic body', () => {
...
Deno.test('Should return on @Res', () => {
  return verifyGetRequest(
...
function verifyStatusCodeTest(statusCode: number) {
  return verifyGetRequest(
...
Deno.test('Should support multiple status codes with the same @Res structure', async () => {
  await verifyStatusCodeTest(400);
  await verifyStatusCodeTest(500);
});

Deno.test('Should not modify the response after headers sent', () => {
  return verifyGetRequest(
...
Deno.test('parses path parameters from the controller description', () => {
...
Deno.test('parses path parameters from the controller description and method description', () => {
  const mainResourceId = 'main-123';
...
function getFullPath(relativePath: string): string {
  ...
  return resolve(testPath, relativePath);
}

function readFileSync(filePath: string) {
  return Deno.readFileSync(getFullPath(filePath));
}

Deno.test('can post a file', () => {
  ...
  return verifyFileUploadRequest(basePath + '/PostTest/File', formData, (_err, res) => {
    ...
    const returnedBuffer = Buffer.from(res.body.buffer, 'base64');
...
Deno.test('can post a file without name', () => {
...
Deno.test('cannot post a file with wrong attribute name', async () => {
  const formData = { wrongAttributeName: `@../../package.json` };
  return verifyFileUploadRequest(
    basePath + '/PostTest/File',
    formData,
    (err, res) => {
      const body = JSON.parse(err.text);
      expect(res.status).to.equal(400);
      expect(body.fields.someFile.message).to.equal("'someFile' is required");
    },
    400,
  );
});

Deno.test('can post multiple files with other form fields', () => {
  const formData = {
    a: 'b',
    c: 'd',
  ...
  return verifyFileUploadRequest(basePath + '/PostTest/ManyFilesAndFormFields', formData, (_err, res) => {
    for (const file of res.body as File[]) {
      const packageJsonBuffer = readFileSync(`../../${file.originalname}`);
      // TODO fix typecasting
      const returnedBuffer = Buffer.from(file.buffer as unknown as string, 'base64');
...
Deno.test('can post multiple files with different field', () => {
  const formData = {
    file_a: '@../../package.json',
  ...
  return verifyFileUploadRequest(`${basePath}/PostTest/ManyFilesInDifferentFields`, formData, (_err, res) => {
    for (const file of res.body as File[]) {
      const packageJsonBuffer = readFileSync(`../../${file.originalname}`);
      // TODO: Fix TSOA file definition in runtime package - why is file a buffer? Show be a base64 string ?
      const returnedBuffer = Buffer.from(file.buffer as unknown as string, 'base64');
      expect(file).to.not.be.undefined;
      expect(file.fieldname).to.be.not.undefined;
      expect(file.originalname).to.be.not.undefined;
...
function verifyFileUploadRequest(
  path: string,
  formData: any,
  verifyResponse: (err: any, res: IResponse) => any = () => {
    /**/
  },
    ...
    request =>
      Object.keys(formData).reduce((req, key) => {
        ...
        values.forEach((v: any) => {
          if (v.startsWith('@')) {
            const filePath = getFullPath(v.slice(1));
            const content = Deno.readFileSync(filePath);
            const fileName = basename(filePath);
            const mimeType = contentType(extname(fileName));
            req.attach(key, new Blob([content], { type: mimeType }), fileName);
          } else {
            req.field(key, v);
          }
        });
